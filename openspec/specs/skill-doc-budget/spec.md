# skill-doc-budget Specification

## Purpose

Keep plugin SKILL.md files within a token budget without losing operative content: cap frontmatter descriptions, single-source the shared orchestration contract, deduplicate within-file constraints, enforce the rules with a lint, and verify content is preserved across restructures.
